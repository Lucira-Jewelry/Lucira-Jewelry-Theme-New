...
document.addEventListener('DOMContentLoaded', function () {
  const firstCardBtn = document.querySelector(
    '.card__media-wrapper:first-of-type .view-similar-btn__text'
  );

  if (!firstCardBtn) return;

  // Show glimpse
  firstCardBtn.classList.add('is-glimpse');

  // Hide after 1.8s (adjust if needed)
  setTimeout(() => {
    firstCardBtn.classList.remove('is-glimpse');
  }, 1800);
});
