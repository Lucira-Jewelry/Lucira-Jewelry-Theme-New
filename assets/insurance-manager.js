...
//   // ==================== QUANTITY SYNC & PRODUCT REMOVAL ====================
  
//   function setupProductRemovalMonitoring() {
//     // Monitor product removal buttons
//     document.addEventListener('click', async (event) => {
//       // Check if it's a remove button or delete button
...
//       if (removeButton) {
//         log('⚠️', 'Product removal detected, checking if last product...');
...
//         // If this is the last non-insurance product and insurance exists
//         if (nonInsuranceCount === 1 && hasInsuranceInCart) {
//           log('⚠️', 'Last product being removed - removing insurance first');
          
//           // Set flag to prevent race conditions
//           state.isRemovingProduct = true;
...
//             // Wait for insurance removal to complete
//             await wait(500);
            
//             // Continue with product removal
//             log('✅', 'Insurance removed, proceeding with product removal');
            
//             // Allow the original remove action to proceed
//             // The product removal will happen naturally after this
            
//           } catch (error) {
//             log('❌', 'Failed to remove insurance before product removal:', error);
//           } finally {
//             showLoader(false);
//             state.isRemovingProduct = false;
//           }
//         }
//       }
//     });
    
//     // Also monitor quantity changes to zero
//     document.addEventListener('change', async (event) => {
//       if (event.target.matches('.cart-item__quantity input[type="number"]')) {
//         const quantity = parseInt(event.target.value);
//         if (quantity === 0) {
//           log('⚠️', 'Quantity set to zero detected');
...
//           // If this was the last product and insurance exists
//           if (nonInsuranceCount === 1 && hasInsuranceInCart) {
//             log('⚠️', 'Last product quantity set to zero - removing insurance first');
...
//               log('✅', 'Insurance removed before product removal');
              
//               // Trigger cart update to show empty cart
//               triggerCartUpdate();
...
//   async function syncInsuranceWithProducts() {
//     if (state.processing || state.isRemovingProduct) {
//       log('⏳', 'Already processing, skipping sync');
//       return;
//     }
