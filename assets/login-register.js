...
// ---------------------------------------------------------
//  UPDATED SEND OTP LISTENER WITH GTM EVENT
// ---------------------------------------------------------
...
if (sendBtn) {
  sendBtn.addEventListener('click', async () => {
    ...
    // Optimistic UI update: Hide mobile, show OTP immediately
...
// ---------------------------------------------------------
//  IMPORTANT: LOAD LATEST WINNER IS CALLED HERE
// ---------------------------------------------------------
document.addEventListener('DOMContentLoaded', function () {
